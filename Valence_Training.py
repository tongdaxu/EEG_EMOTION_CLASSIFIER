...
training_data_df = pd.read_csv("BandPower_Val_Test_1-32-256.csv", dtype=float)

# Pull out columns for X (data to train with) and Y (value to predict)
X_training = training_data_df.drop('Valence', axis=1).values
Y_training = training_data_df[['Valence']].values

# Load testing data set from CSV file
test_data_df = pd.read_csv("BandPower_Val_Train_1-32-256.csv", dtype=float)
